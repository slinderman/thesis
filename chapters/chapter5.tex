...
\cite{Paninski-2004, Truccolo-2005, Pillow-2008}. When the spike
counts are Poisson distributed, then under general
conditions~\cite{Paninski-2004} the likelihood of the spike counts
...
% or the expected predictive likelihood of heldout test data.
...
often done in GLM analyses. The simplest way to incorporate these exteral covariates,
