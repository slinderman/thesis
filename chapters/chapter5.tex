...
inhibitory interactions with a simple additive model because this could
...
% With these samples, we can compute unbiased expectations with
% respect to the posterior distribution.  For example, we can compute
% the expected probability that two neurons belong to the same class,
% the expected weight of a functional connection between two neurons,
% or the expected predictive likelihood of held-out test data.
...
Fortunately, we can make posterior inference of the network
...
\begin{figure}[t!]
  ...
  \begin{subfigure}[b]{2.25in}
    ...
    \caption{}
    \vspace{-.2in}
    \includegraphics[width=\textwidth]{figures/ch5/rgc_pred_ll_bar.pdf}
    \label{fig:rgc_pll}
  \end{subfigure}
  ~
  \begin{subfigure}[b]{1.6in}
    ...
    \caption{}
    \vspace{-.2in}
    \includegraphics[width=\textwidth]{figures/ch5/rgc_pairwise_distance_scatter.pdf}
    \label{fig:rgc_dist}
  \end{subfigure}
  ~
  \begin{subfigure}[b]{1.6in}
...
\sloppy We fit our model to the measured spike trains for each of the
...
\begin{figure}[t!]
  ...
  \begin{subfigure}[b]{1.75in}
    ...
    \caption{}
    \vspace{-.2in}
    \includegraphics[width=\textwidth]{figures/ch5/hipp_inferred_locations.pdf}
  ...
  %  \caption{}
  %  \vspace{-.2in}
  %  \includegraphics[width=\textwidth]{figures/ch5/hipp_lds_locations.pdf}
  ...
  \begin{subfigure}[b]{1.75in}
    ...
    \caption{}
    \vspace{-.2in}
    \includegraphics[width=\textwidth]{figures/ch5/hipp_pairwise_distance_scatter.pdf}
  ...
  \begin{subfigure}[b]{2.25in}
    ...
    \caption{}
    \vspace{-.2in}
    \includegraphics[width=\textwidth]{figures/ch5/hipp_pred_ll_bar.pdf}
    \label{fig:hipp_pll}
  \end{subfigure}
  ~
  \begin{subfigure}[b]{1.85in}
...
give rise to the diagonally banded connection probabilities reflecting the
...
%algebra, performance scales almost linearly in the number of cores.
We
...
As we explore deeper brain circuits that are further removed from
