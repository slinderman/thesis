...
\begin{align*}
  \nonumber  p(s_{t,n} \given \psi_{t,n}, \nu_n)
  &= c(s_{t,n}, \nu_n) \, \sigma(\psi_{t,n})^{a(s_{t,n}, \nu_n)} \,
  (1-\sigma(\psi_{t,n}))^{d(s_{t,n}, \nu_n)} \\
  &= c(s_{t,n}, \nu_n)
...
The parameters of the model are aggregated in~$\btheta$.
