...
theoretical models are just prior distributions on activity ---
...
inference in this model are equivalent to a generalized linear model
...
trains using Bayesian inference for generalized linear models and a
...
distribution, as in~\citep{Barber2003, Ma2006, beck2007exact}. 
...
\begin{assumption}
  ...
  pair of neurons, $(n,m)$, the variable~$a_{m \to n} \in \{0,1\}$
...
\begin{align*}
  ...
  w_{m \to n} &\sim \distGaussian(\mu_{c_n \from c_m}, \sigma^2).
\end{align*}
