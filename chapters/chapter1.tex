...
in probabilistic terms, our hypotheses about structure in our 
data. The key ingredients are latent variables that reflect the underlying state 
...
will build upon this foundation by developing more sophisticated models
