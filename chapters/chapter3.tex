...
Scalability plots:
\begin{enumerate}
\item Wall-clock time per iteration (broken down into time spent updating augmentation variables, updating network, and updating latent variables) as a function of:
  \begin{enumerate}
  \item Number of neurons (fixed sparsity)
  \item Degree of sparsity (fixed number of neurons)
  \item Number of time bins
  \end{enumerate}
\end{enumerate}
