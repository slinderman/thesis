...
\begin{figure}[t]
  ...
  \end{center}
  \vspace{-3em}
  \caption[True locations and inferred network of hippocampal place cells]{True locations and inferred network of hippocampal place cells}
  \label{fig:hawkes_hipp_data}
\end{figure}
\end{comment}
...
%    \end{subfigure}
  ...
  \caption[Inferred weights and locations of hippocampal place cells]{ Inferred
    ...
    \textbf{top:} True locations of the cells. Colors indicate the four neurons plotted below.
    \textbf{bottom:} 250 samples from the posterior
    distribution over neuron locations for the four colored cells.
  }
...
the two dimensional PCA embedding is highly skewed.\footnote{First, we binned the
  ...
  with a Guassian kernel of width $1$s to estimate the firing rate.
