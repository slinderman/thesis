...
% The probabilistic model can be further decomposed into four components: 
% \begin{enumerate*}[label=\itshape\alph*\upshape)]
% \item a model of interpretable latent structure,
% \item a network model that defines the probability of a functional interaction network given the latent structure; 
% \item an autoregressive activation model that relates activation at time~$t$ to the preceding activity of functionally connected neurons; and
% \item an observation model that provides a distribution over measured activity given the instantaneous activation.
% \end{enumerate*}
